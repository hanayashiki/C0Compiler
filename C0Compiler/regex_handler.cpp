...
RegexHandler::RegexHandler() {
	...
	match_patterns[JUMP_TO_NEXT_STATEMENT_IF_COMP_] =
		match_patterns[JUMP_TO_NEXT_STATEMENT] + "|" + right_par;
	...
	stop_patterns[JUMP_TO_NEXT_STATEMENT_FOR_] =
		stop_patterns[JUMP_TO_NEXT_STATEMENT];
	stop_patterns[JUMP_TO_NEXT_STATEMENT_CASE_] =
		stop_patterns[JUMP_TO_NEXT_STATEMENT];
	stop_patterns[JUMP_TO_NEXT_STATEMENT_IF_COMP_] =
		stop_patterns[JUMP_TO_NEXT_STATEMENT];
	match_patterns[JUMP_TO_NEXT_DEFINITION_FUNC] =
		stop_patterns[JUMP_TO_NEXT_STATEMENT];
}
